...
export default function MultiActionAreaCard() {
  return (
    <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-8 mt-20">
        ...
        <div key={index} className="relative cursor-pointer">
          <Card sx={{ maxWidth: 300 }}>
            ...
            <CardActions>
              <Button
                variant="contained"
                className="bg-brandPrimary text-white hover:bg-neneutralDGrey"
                onClick={() => {
                  // Handle event organization action here
                  console.log(`Organize your event: ${card.title}`);
                }}
              >
                Organize your event
              </Button>
